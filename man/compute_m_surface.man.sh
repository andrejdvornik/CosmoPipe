...
function _inp_var { 
  ...
  echo BLU BV:E1NAME BV:E2NAME BV:ETYPE BV:G1NAME BV:G2NAME BV:NBINR BV:NBINSNR BV:RNAME BV:SIMLABEL BV:SNRNAME BV:WEIGHTNAME DEF PYTHON3BIN RED RUNROOT SCRIPTPATH
} 
#}}}
