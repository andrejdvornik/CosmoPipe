...
function _inp_var { 
  ...
  echo ALLPATCH BINNING BLU BV:BINSLOP BV:DECNAME BV:NTHETABINXI BV:NTHREADS BV:PATCHLIST BV:PSFE1NAME BV:PSFE2NAME BV:RANAME BV:THETAMAXXI BV:THETAMINXI BV:TOMOLIMS BV:WEIGHTNAME DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
} 
#}}}
