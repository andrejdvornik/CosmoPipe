#
# add_cosmosis_ini.sh Documentation & Housekeeping functions
#
...
function _prompt { 
  ...
  then
    _message "@BLU@=============================================@DEF@\n"
    _message "@BLU@== @RED@ Running add_cosmosis_ini.sh Mode @BLU@ ==@DEF@\n"
    _message "@BLU@=============================================@DEF@\n"
  fi 
}
#}}}
...
function _runcommand { 
  ...
  echo bash @RUNROOT@/@SCRIPTPATH@/add_cosmosis_ini.sh
}
#}}}
