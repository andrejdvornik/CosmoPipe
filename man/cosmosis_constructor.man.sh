...
function _inp_var { 
  ...
  echo BLINDING BV:APODISATIONWIDTH BV:BLIND BV:BOLTZMAN BV:COSMOSIS_PIPELINE BV:LIST_INPUT_SAMPLER BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:NBANDPOWERS BV:NMAXCOSEBIS BV:NMINCOSEBIS BV:NPAIRBASE BV:NTHREADS BV:NXIPM BV:SAMPLER BV:SAVE_TPDS BV:STATISTIC BV:THETAMAXXI BV:THETAMAXXIM BV:THETAMINXI BV:THETAMINXIM BV:TOMOLIMS CONFIGPATH DATABLOCK RUNROOT STORAGEPATH SURVEY
} 
#}}}
