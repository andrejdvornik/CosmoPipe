...
function _inp_var { 
  ...
  echo BLINDING BV:APODISATIONWIDTH BV:BLIND BV:BOLTZMAN BV:CHAINSUFFIX BV:COSMOSIS_PIPELINE BV:IAMODEL BV:LIST_INPUT_SAMPLER BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:MASKDATAPOINT BV:MASSDEP_COVARIANCE BV:NBANDPOWERS BV:NMAXCOSEBIS BV:NMINCOSEBIS BV:NPAIRBASE BV:NTHREADS BV:NXIPM BV:SAMPLER BV:SAVE_TPDS BV:SPLITMODE BV:STATISTIC BV:THETAMAXXI BV:THETAMAXXIM BV:THETAMINXI BV:THETAMINXIM BV:TOMOLIMS CONFIGPATH DATABLOCK RUNROOT STORAGEPATH SURVEY
} 
#}}}
