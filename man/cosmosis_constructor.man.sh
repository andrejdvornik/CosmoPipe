...
function _inp_var { 
  ...
  echo BLIND BLINDING DB:BOLTZMAN CONFIGPATH COSMOSIS_PIPELINE DATABLOCK NMAXCOSEBIS RUNROOT DB:SAMPLER DB:STATISTIC STORAGEPATH SURVEY THETAMAXCOV THETAMINCOV
} 
#}}}
