...
function _inp_var { 
  ...
  echo BLU BV:ADDITIONALFLAGS BV:CALIBWEIGHTNAME BV:MINNHC BV:NTHREADS BV:OPTIMISE BV:SOMFEATURES BV:TOMOLIMS BV:WEIGHTNAME BV:ZPHOTNAME BV:ZSPECNAME DATABLOCK DEF LOGPATH PIPELINE P_RSCRIPT RED RUNROOT STORAGEPATH
} 
#}}}
