...
function _inp_var { 
  ...
  echo BLU BV:ADDITIONALFLAGS BV:IMAGNAME BV:MINNHC BV:NTHREADS BV:OPTIMISE BV:REFMAGNAME BV:WEIGHTNAME BV:ZPHOTNAME BV:ZSPECNAME DATABLOCK DEF P_RSCRIPT RED RUNROOT STORAGEPATH
} 
#}}}
