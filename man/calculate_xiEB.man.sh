...
function _inp_var { 
  ...
  echo BINNING BLU BV:BOLTZMAN BV:NTHREADS BV:NXIPM BV:THETAMAXXI BV:THETAMINXI BV:TOMOLIMS CONFIGPATH DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
} 
#}}}
