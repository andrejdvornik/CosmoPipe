...
function _inp_var { 
  ...
  echo BINNING BLU BV:BOLTZMAN BV:NTHREADS BV:NTHETAREBIN BV:THETAMAX BV:THETAMIN BV:TOMOLIMS CONFIGPATH DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
} 
#}}}
