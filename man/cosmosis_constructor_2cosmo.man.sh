...
function _inp_var { 
  ...
  echo BLINDING BV:APODISATIONWIDTH BV:BLIND BV:BOLTZMAN BV:COSMOSIS_PIPELINE BV:DVLENGTH BV:LIST_INPUT_SAMPLER BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:NMAXCOSEBIS BV:NMINCOSEBIS BV:NPAIRBASE_XI BV:NTHETAREBIN BV:SAMPLER BV:SPLITMODE BV:STATISTIC BV:THETAMAX BV:THETAMAXM BV:THETAMIN BV:THETAMINM BV:TOMOLIMS BV:ZBIN CONFIGPATH DATABLOCK P_SED_INPLACE RUNROOT STORAGEPATH SURVEY
}
#}}}
