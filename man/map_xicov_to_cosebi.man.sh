...
function _inp_var { 
  ...
  echo BINNING BV:NMAXCOSEBIS BV:NTHETABIN BV:NTHREADS BV:THETAMAX BV:THETAMIN BV:TOMOLIMS CONFIGPATH DATABLOCK PYTHON3BIN RUNROOT SCRIPTPATH STORAGEPATH
} 
#}}}
