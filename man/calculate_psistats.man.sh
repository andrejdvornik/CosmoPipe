...
function _inp_var { 
  ...
  echo BV:BINNINGGT BV:BINNINGWT BLU BV:PSISTATSMODE BV:NMAXPSISTATS BV:THETAMAXGT BV:THETAMINGT BV:THETAMAXWT BV:THETAMINWT DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
