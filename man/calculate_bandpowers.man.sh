...
function _inp_var { 
  ...
  echo BV:BINNING BLU BV:APODISATIONWIDTH BV:BANDPOWERMODE BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:NBANDPOWERS BV:THETAMAX BV:THETAMIN DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
