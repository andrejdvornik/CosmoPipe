...
function _inp_var { 
  ...
  echo BINNING BLU BV:APODISATIONWIDTH BV:BANDPOWERMODE BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:NBANDPOWERS BV:THETAMAXXI BV:THETAMINXI DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
} 
#}}}
