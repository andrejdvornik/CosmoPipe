...
function _inp_var { 
  ...
  echo BINNING BLU BV:APODISATIONWIDTH BV:MODE BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:NBANDPOWERS BV:THETAMAX BV:THETAMIN DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
