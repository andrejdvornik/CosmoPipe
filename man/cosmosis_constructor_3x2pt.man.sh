...
function _inp_var { 
  ...
  echo BLINDING BV:APODISATIONWIDTH BV:BLIND BV:BOLTZMAN BV:CHAINSUFFIX BV:COSMOSIS_PIPELINE BV:IAMODEL BV:LIST_INPUT_SAMPLER BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:NBANDPOWERS BV:NMAXCOSEBIS BV:NMINCOSEBIS BV:NPAIRBASE BV:NTHREADS BV:NTHETAREBIN BV:SAMPLER BV:SAVE_TPDS BV:STATISTIC BV:THETAMAX BV:THETAMAXM BV:THETAMIN BV:THETAMINM BV:TOMOLIMS CONFIGPATH DATABLOCK RUNROOT STORAGEPATH SURVEY
}
#}}}
