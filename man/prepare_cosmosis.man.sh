...
function _inp_var { 
  ...
  echo ALLPATCH BLU BV:BLIND BV:BOLTZMAN BV:COSMOSIS_PATCHLIST BV:IAMODEL BV:PRIOR_A1 BV:PRIOR_A2 BV:PRIOR_ABARY BV:PRIOR_A_IA BV:PRIOR_AIA BV:PRIOR_ALPHA1 BV:PRIOR_ALPHA2 BV:PRIOR_A_PIV BV:PRIOR_BETA BV:PRIOR_B_IA BV:PRIOR_BIAS_TA BV:PRIOR_F_R_1 BV:PRIOR_F_R_2 BV:PRIOR_F_R_3 BV:PRIOR_F_R_4 BV:PRIOR_F_R_5 BV:PRIOR_F_R_6 BV:PRIOR_H0 BV:PRIOR_LOG10_M_MEAN_1 BV:PRIOR_LOG10_M_MEAN_2 BV:PRIOR_LOG10_M_MEAN_3 BV:PRIOR_LOG10_M_MEAN_4 BV:PRIOR_LOG10_M_MEAN_5 BV:PRIOR_LOG10_M_MEAN_6 BV:PRIOR_LOG10_M_PIV BV:PRIOR_LOGTAGN BV:PRIOR_MNU BV:PRIOR_NS BV:PRIOR_OMBH2 BV:PRIOR_OMCH2 BV:PRIOR_OMEGAK BV:PRIOR_S8INPUT BV:PRIOR_W BV:PRIOR_WA BV:PRIOR_Z_PIV BV:TOMOLIMS DATABLOCK DEF PATCHLIST RED RUNROOT STORAGEPATH SURVEY
} 
#}}}
