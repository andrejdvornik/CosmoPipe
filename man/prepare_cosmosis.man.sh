...
function _inp_var { 
  ...
  echo ALLPATCH BLU BV:BLIND BV:BOLTZMAN BV:COSMOSIS_PATCHLIST BV:IAMODEL BV:PRIOR_A1 BV:PRIOR_A2 BV:PRIOR_ABARY BV:PRIOR_AIA BV:PRIOR_ALPHA1 BV:PRIOR_ALPHA2 BV:PRIOR_BIAS_TA BV:PRIOR_H0 BV:PRIOR_LOGTAGN BV:PRIOR_MNU BV:PRIOR_NS BV:PRIOR_OMBH2 BV:PRIOR_OMCH2 BV:PRIOR_OMEGAK BV:PRIOR_S8INPUT BV:PRIOR_W BV:PRIOR_WA BV:PRIOR_Z_PIV BV:TOMOLIMS DATABLOCK DEF PATCHLIST RED RUNROOT STORAGEPATH SURVEY
} 
#}}}
