...
function _inp_var { 
  ...
  echo BLINDING BV:BOLTZMAN BV:CHAINSUFFIX BV:ITERATION BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:NBANDPOWERS BV:NMAXCOSEBIS BV:NTHETAREBIN BV:STATISTIC BV:THETAMAX BV:THETAMIN BV:TOMOLIMS DATABLOCK PYTHON3BIN RUNROOT SCRIPTPATH STORAGEPATH SURVEY
}
#}}}
