...
function _inp_var { 
  ...
  echo BLINDING BV:BOLTZMAN BV:LMAXBANDPOWERS BV:LMINBANDPOWERS BV:NBANDPOWERS BV:NMAXCOSEBIS BV:NXIPM BV:STATISTIC BV:THETAMAXXI BV:THETAMINXI BV:TOMOLIMS DATABLOCK PYTHON3BIN RUNROOT SCRIPTPATH STORAGEPATH SURVEY
} 
#}}}
