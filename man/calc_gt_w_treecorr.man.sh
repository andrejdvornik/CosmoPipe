...
function _inp_var { 
  ...
  echo ALLPATCH BINNING BLU BV:BINSLOPNN BV:BINSLOPNG BV:DECNAME BV:LENSDECNAME BV:RANDDECNAME BV:E1NAME BV:E2NAME BV:NTHETABIN BV:NTHREADS BV:PATCH_CENTERFILE BV:RANAME BV:LENSRANAME BV:RANDRANAME BV:THETAMAX BV:THETAMIN BV:TOMOLIMS BV:WEIGHTNAME BV:LENSWEIGHTNAME DATABLOCK DEF BV:PATCHLIST PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
