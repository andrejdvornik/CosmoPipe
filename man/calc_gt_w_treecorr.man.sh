...
function _inp_var { 
  ...
  echo ALLPATCH BV:BINNINGGT BLU BV:BINSLOPNN BV:BINSLOPNG BV:DECNAME BV:LENSDECNAME BV:RANDDECNAME BV:E1NAME BV:E2NAME BV:NTHETABINGT BV:NTHREADS BV:PATCH_CENTERFILE BV:RANAME BV:LENSRANAME BV:RANDRANAME BV:THETAMAXGT BV:THETAMINGT BV:TOMOLIMS BV:WEIGHTNAME BV:LENSWEIGHTNAME DATABLOCK DEF PATCHLIST PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
