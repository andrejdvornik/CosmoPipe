...
function _inp_var { 
  ...
  #echo BLU BV:H0_IN BV:OMEGAM_IN BV:OMEGAV_IN BV:MINMASS BV:MAXMASS BV:MINZ BV:MAXZ BV:STELLARMASS BV:REDSHIFT DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
  echo BLU BV:H0_IN BV:OMEGAM_IN BV:OMEGAV_IN BV:STELLARMASS BV:REDSHIFT DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
