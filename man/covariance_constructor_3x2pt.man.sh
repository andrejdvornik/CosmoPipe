...
function _inp_var { 
  ...
  echo BLINDING BV:APODISATIONWIDTH BV:BOLTZMAN BV:CHAINSUFFIX BV:COVNCORES BV:DECNAME BV:GAUSS BV:IAMODEL BV:ITERATION BV:LBINSCOV BV:LMAXBANDPOWERS BV:LMAXCOV BV:LMINBANDPOWERS BV:LMINCOV BV:MIXTERM BV:MIXTERM_BASEFILE BV:NBANDPOWERS BV:NMAXCOSEBIS BV:NONGAUSS BV:NPAIRBASE_XI BV:NPAIRBASE_GT BV:NPAIRBASE_WT BV:NTHETABIN BV:NTHETAREBIN BV:PRIOR_ABARY BV:PRIOR_AIA BV:PRIOR_H0 BV:PRIOR_LOGTAGN BV:PRIOR_MNU BV:PRIOR_NS BV:PRIOR_OMBH2 BV:PRIOR_OMCH2 BV:PRIOR_SIGMA8 BV:PRIOR_W BV:PRIOR_WA BV:RANAME BV:SECONDSTATISTIC BV:MODES BV:NSMFBINS BV:NLENSBINS BV:NSMFLENSBINS BV:SPLIT_GAUSS BV:SSC BV:STATISTIC BV:SURVEYAREADEG BV:SURVEYMASKFILE BV:THETAMAX BV:THETAMIN BV:TOMOLIMS BV:WEIGHTNAME CONFIGPATH DATABLOCK RUNROOT STORAGEPATH SURVEY
}
#}}}
