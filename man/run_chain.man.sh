...
function _inp_var { 
  ...
  echo BINNING BLU BV:NMAXCOSEBIS BV:NTHREADS BV:SAMPLER BV:STATISTIC BV:THETAMAXXI BV:THETAMINXI CONFIGPATH DATABLOCK DEF LOGPATH PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH SURVEY
} 
#}}}
