...
function _inp_var { 
  ...
  echo ALLPATCH BINNING BLU BV:BINSLOPNN BV:LENSDECNAME BV:RANDDECNAME BV:NTHETABIN BV:NTHREADS BV:PATCH_CENTERFILE BV:LENSRANAME BV:RANDRANAME BV:THETAMAX BV:THETAMIN BV:LENSWEIGHTNAME DATABLOCK DEF PATCHLIST PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
