...
function _inp_var { 
  ...
  echo ALLPATCH BV:BINNING BLU BV:BINSLOPNN BV:LENSDECNAME BV:RANDDECNAME BV:NTHETABINWT BV:NTHREADS BV:PATCH_CENTERFILE BV:LENSRANAME BV:RANDRANAME BV:THETAMAXWT BV:THETAMINWT BV:LENSWEIGHTNAME DATABLOCK DEF PATCHLIST PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
