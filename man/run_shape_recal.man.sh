...
function _inp_var { 
  ...
  echo BLU BV:E1NAME BV:E2NAME BV:NBINR BV:NBINSNR BV:PSFE1NAME BV:PSFE2NAME BV:SNRNAME BV:TOMOLIMS BV:WEIGHTNAME BV:ZPHOTNAME DEF PYTHON3BIN RED RUNROOT SCRIPTPATH
} 
#}}}
