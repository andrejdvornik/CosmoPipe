...
function _inp_var { 
  ...
  if [ "@BV:MIXTERM@" == "True" ]
  then 
    echo BV:APODISATIONWIDTH BV:COVNCORES BV:DECNAME BV:GAUSS BV:LBINSCOV BV:LMAXBANDPOWERS BV:LMAXCOV BV:LMINBANDPOWERS BV:LMINCOV BV:MIXTERM BV:NBANDPOWERS BV:NMAXCOSEBIS BV:NONGAUSS BV:NPAIRBASE BV:MIXTERM_BASEFILE BV:NTHETABINXI BV:NXIPM BV:PRIOR_AIA BV:PRIOR_H0 BV:PRIOR_MNU BV:PRIOR_NS BV:PRIOR_OMBH2 BV:PRIOR_OMCH2 BV:PRIOR_S8INPUT BV:PRIOR_W BV:PRIOR_WA BV:RANAME BV:SECONDSTATISTIC BV:SPLIT_GAUSS BV:SSC BV:STATISTIC BV:THETAMAXXI BV:THETAMINXI BV:TOMOLIMS BV:WEIGHTNAME CONFIGPATH DATABLOCK RUNROOT STORAGEPATH SURVEY SURVEYAREADEG SURVEYMASKFILE
  else
    echo BV:APODISATIONWIDTH BV:COVNCORES BV:DECNAME BV:GAUSS BV:LBINSCOV BV:LMAXBANDPOWERS BV:LMAXCOV BV:LMINBANDPOWERS BV:LMINCOV BV:MIXTERM BV:NBANDPOWERS BV:NMAXCOSEBIS BV:NONGAUSS BV:NPAIRBASE BV:NTHETABINXI BV:NXIPM BV:PRIOR_AIA BV:PRIOR_H0 BV:PRIOR_MNU BV:PRIOR_NS BV:PRIOR_OMBH2 BV:PRIOR_OMCH2 BV:PRIOR_S8INPUT BV:PRIOR_W BV:PRIOR_WA BV:RANAME BV:SECONDSTATISTIC BV:SPLIT_GAUSS BV:SSC BV:STATISTIC BV:THETAMAXXI BV:THETAMINXI BV:TOMOLIMS BV:WEIGHTNAME CONFIGPATH DATABLOCK RUNROOT STORAGEPATH SURVEY SURVEYAREADEG SURVEYMASKFILE
  fi
