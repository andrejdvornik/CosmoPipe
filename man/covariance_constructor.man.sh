...
function _inp_var { 
  ...
  echo BV:GAUSS BV:LBINSCOV BV:LMAXCOV BV:LMINCOV BV:NONGAUSS BV:NTHETABINXI BV:SPLIT_GAUSS BV:SSC BV:STATISTIC BV:THETAMAXXI BV:THETAMINXI DATABLOCK RUNROOT STORAGEPATH SURVEY
} 
#}}}
