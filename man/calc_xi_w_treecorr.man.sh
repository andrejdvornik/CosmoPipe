...
function _inp_var { 
  ...
  echo ALLPATCH BINNING BLU BV:BINSLOP BV:DECNAME BV:E1NAME BV:E2NAME BV:NTHETABIN BV:NTHREADS BV:PATCH_CENTERFILE BV:RANAME BV:THETAMAX BV:THETAMIN BV:TOMOLIMS BV:WEIGHTNAME DATABLOCK DEF PATCHLIST PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
} 
#}}}
