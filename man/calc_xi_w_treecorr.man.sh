...
function _inp_var { 
  ...
  echo ALLPATCH BINNING BLU BV:NTHETABINXI BV:NTHREADS BV:THETAMAXXI BV:THETAMINXI correlation DATABLOCK DECNAME DEF E1NAME E2NAME function LOGPATH PATCHLIST PYTHON3BIN RANAME RED REDBin RUNROOT SCRIPTPATH STORAGEPATH TOMOLIMS WEIGHTNAME $ZBIN2
} 
#}}}
