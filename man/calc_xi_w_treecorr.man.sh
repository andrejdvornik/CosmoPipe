...
function _inp_var { 
  ...
  echo ALLPATCH BINNING BLU BV:NTHETABINXI BV:NTHREADS BV:THETAMAXXI BV:THETAMINXI DATABLOCK DECNAME DEF E1NAME E2NAME LOGPATH PATCHLIST PYTHON3BIN RANAME RED RUNROOT SCRIPTPATH STORAGEPATH TOMOLIMS WEIGHTNAME
} 
#}}}
