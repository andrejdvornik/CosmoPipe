...
function _inp_var { 
  ...
  echo ALLPATCH BINNING BLU BV:NTHETABINXI BV:NTHREADS BV:THETAMAXXI BV:THETAMINXI DATABLOCK BV:DECNAME DEF BV:E1NAME BV:E2NAME LOGPATH PATCHLIST PYTHON3BIN BV:RANAME RED RUNROOT SCRIPTPATH STORAGEPATH BV:TOMOLIMS BV:WEIGHTNAME
} 
#}}}
