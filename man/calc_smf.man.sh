...
function _inp_var { 
  ...
  echo ALLPATCH BLU BV:NSMFBINS BV:H0_IN BV:OMEGAM_IN BV:OMEGAV_IN BV:REDSHIFT BV:STELLARMASS SURVEYAREADEG DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
}
#}}}
