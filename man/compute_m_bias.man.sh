...
function _inp_var { 
  ...
  echo ALLPATCH BLU BV:M1NAME BV:M2NAME BV:RNAME BV:SNRNAME BV:WEIGHTNAME BV:MBIASCORR DATABLOCK DEF MBIASCORR PATCHLIST PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
} 
#}}}
