...
function _inp_var { 
  ...
  echo BLU BV:LENSLIMSX BV:LENSLIMSY BV:LENSPREFIX BV:NZSTEP BV:REDSHIFT BV:SLICEIN BV:STACKED_NZ BV:STELLARMASS BV:VOLUMELIMITED BV:ZDEPERR BV:ZSIGMA DATABLOCK DEF PYTHON3BIN RED RUNROOT SCRIPTPATH STORAGEPATH
} 
#}}}
