...
function _inp_var { 
  ...
  echo BLU BV:ADDITIONALFLAGS BV:CALIBWEIGHTNAME BV:NITER BV:NTHREADS BV:SOMDIM BV:SOMFEATURES BV:ZPHOTNAME BV:ZSPECNAME DATABLOCK DEF P_RSCRIPT RED RUNROOT STORAGEPATH
} 
#}}}
