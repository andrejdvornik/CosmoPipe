...
plt.colorbar()
plt.savefig(md+'/PLOTS/w_map_%s_V1.0.0_rev1.png' % (runid))
plt.close()
...
plt.savefig(md+'/PLOTS/c1_map_%s_V1.0.0_rev1.pdf' % (runid))
plt.close()
...
plt.imshow(c2_map, origin='lower',
           ...
           cmap=cmap, clim=(-max, max)) #, vmin=-0.005, vmax=0.005)
plt.colorbar()
plt.savefig(md+'/PLOTS/c2_map_%s_V1.0.0_rev1.pdf' % (runid))
plt.close()
...
plt.imshow(e1_mean, origin='lower',
           ...
           cmap=cmap, clim=(-max, max)) #, vmin=-0.005, vmax=0.005)
plt.colorbar()
plt.savefig(md+'/PLOTS/e1_mean_%s_V1.0.0_rev1.png' % (runid))
plt.close()
...
plt.imshow(e2_mean, origin='lower',
           ...
           cmap=cmap, clim=(-max, max)) #, vmin=-0.005, vmax=0.005)
plt.colorbar()
plt.savefig(md+'/PLOTS/e2_mean_%s_V1.0.0_rev1.png' % (runid))
plt.close()
...
plt.ylabel('e1_mean')
plt.ylim(-0.01,0.01)
plt.savefig(md+'/PLOTS/c1_e1_%s_V1.0.0_rev1.png' % (runid))
plt.close()
...
plt.ylabel('e2_mean')
plt.ylim(-0.01,0.01)
plt.savefig(md+'/PLOTS/c2_e2_%s_V1.0.0_rev1.png' % (runid))
plt.clf()
...
####
####plt.savefig(md+'/PLOTS/e_X_Y_%s_V1.0.0_rev1.png' % (runid))
#####plt.show()
##
#####################################################
#####################################################
