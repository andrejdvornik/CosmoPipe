...
ALLOPTS="ALLPATCH BLIND BLINDING CONFIGPATH DATE DZPRIORMU DZPRIORSD \
...
for OPT in $OPTLIST
do 
  sed -i '' "s#\@${OPT}\@#${!OPT}#g" ${RUNROOT}/${SCRIPTPATH}/*.* ${RUNROOT}/run_COSMOLOGY_PIPELINE.sh ${RUNROOT}/${CONFIGPATH}/{.,*}/*.*
done 
...
#sed -i '' "s#\@COSMOPIPELFNAME\@#${COSMOPIPELFNAME}#g" ${RUNROOT}/${SCRIPTPATH}/*.* ${RUNROOT}/run_COSMOLOGY_PIPELINE.sh ${RUNROOT}/${CONFIGPATH}/{.,*}/*.*
...
#sed -i '' "s#\@FILEBODY\@#${FILEBODY}#g" ${RUNROOT}/${SCRIPTPATH}/*.* ${RUNROOT}/run_COSMOLOGY_PIPELINE.sh ${RUNROOT}/${CONFIGPATH}/{.,*}/*.*
...
#sed -i '' "s#\@THETAMINXI\@#${THETAMINXI}#g" ${RUNROOT}/${SCRIPTPATH}/*.* ${RUNROOT}/run_COSMOLOGY_PIPELINE.sh  ${RUNROOT}/${CONFIGPATH}/{.,*}/*.*
#sed -i '' "s#\@THETAMAXXI\@#${THETAMAXXI}#g" ${RUNROOT}/${SCRIPTPATH}/*.* ${RUNROOT}/run_COSMOLOGY_PIPELINE.sh  ${RUNROOT}/${CONFIGPATH}/{.,*}/*.*
#sed -i '' "s#\@NTHETABINXI\@#${NTHETABINXI}#g" ${RUNROOT}/${SCRIPTPATH}/*.* ${RUNROOT}/run_COSMOLOGY_PIPELINE.sh  ${RUNROOT}/${CONFIGPATH}/{.,*}/*.*
