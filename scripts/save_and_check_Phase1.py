...
FolderNamePatches = '@PATCHPATH@/'
FolderNameInputs  = '@RUNROOT@/@STORAGEPATH@/'
FolderNameCov     = FolderNameInputs+'covariance/'

cosebis_filename = FolderNameInputs+'/MCMC/@SURVEY@_INPUT/@BLINDING@/cosebis_@SURVEY@_@ALLPATCH@_combined_'+cat_version+'@FILESUFFIX@_filt_blind'+blind+'_'+name_tag+'_nbins@NMAXCOSEBIS@_theta_@THETAMINCOV@_@THETAMAXCOV@.asc'
...
# Sources:
# read from file
filename = FolderNameCov+'input/@SURVEY@_blind'+blind+'_neff.txt'
nGal_source = np.loadtxt(filename)

# read from file
filename = FolderNameCov+'input/@SURVEY@_blind'+blind+'_sigmae.txt'
...
def saveFitsCOSEBIs_KIDS1000():
    ...
    covName   = FolderNameCov+'/output/Covariance_blind'+blind+'_nMaximum_@NMAXCOSEBIS@_@THETAMINCOV@_@THETAMAXCOV@_nBins@NTOMOBINS@.ascii'
    
    saveName  = FolderNameInputs+'/MCMC/@SURVEY@_INPUT/@BLINDING@/cosebis_@SURVEY@_@ALLPATCH@_combined_'+cat_version+'@FILESUFFIX@_filt_blind'+blind+'_'+name_tag+'_nbins@NMAXCOSEBIS@_theta_@THETAMINCOV@_@THETAMAXCOV@_cosmosis.fits'
    
    saveFitsTwoPoint(
        nbTomoN=0, nbTomoG=@NTOMOBINS@,
        nbModes=@NMAXCOSEBIS@,
        prefix_Flinc=None,
...
filename = FolderNameInputs+'/MCMC/@SURVEY@_INPUT/@BLINDING@/cosebis_@SURVEY@_@ALLPATCH@_combined_'+cat_version+'@FILESUFFIX@_filt_blind'+blind+'_'+name_tag+'_nbins@NMAXCOSEBIS@_theta_@THETAMINCOV@_@THETAMAXCOV@_cosmosis.fits'
title='KiDS'
