...
class TwoPointBuilder:
    ...
    def __init__(self,
                  ...
                  N_theta_ee=9, theta_min_ee=0.5, theta_max_ee=300,
                  N_ell_ee=8, ell_min_ee=100, ell_max_ee=1500,
                  nbModes_ee=5,
                  N_theta_ne=9, theta_min_ne=0.5, theta_max_ne=300,
                  N_ell_ne=8, ell_min_ne=100, ell_max_ne=1500,
                  nbModes_ne=5,
                  N_theta_nn=9, theta_min_nn=0.5, theta_max_nn=300,
    ...
    def makeTomoAngDict(self):
        ...
        tomoAngDict = { ## Don't touch the order of this list
            ...
            labConv.Psi_gg:  [self.__pairListNN, self.nbModes_ne, self.nArr_ne],
        }
...
def saveFitsTwoPoint(
        nbTomoN=0, nbTomoG=0, nbObs=0,
        N_theta_ee=12, theta_min_ee=0.5, theta_max_ee=300,
        N_ell_ee=8, ell_min_ee=100, ell_max_ee=1500,
        nbModes_ee=5,
        N_theta_ne=12, theta_min_ne=0.5, theta_max_ne=300,
        N_ell_ne=8, ell_min_ne=100, ell_max_ne=1500,
        nbModes_ne=5,
        N_theta_nn=12, theta_min_nn=0.5, theta_max_nn=300,
        N_ell_nn=8, ell_min_nn=100, ell_max_nn=1500,
        nbModes_nn=5,
        nnAuto=False,
        smbinAuto=True,
    ...
    TPBuilder = TwoPointBuilder(
        ...
        N_theta_ee=N_theta_ee, theta_min_ee=theta_min_ee, theta_max_ee=theta_max_ee,
        N_ell_Ee=N_ell_ee, ell_min_ee=ell_min_ee, ell_max_ee=ell_max_ee,
        nbModes_ee=nbModes_ee,
        N_theta_ne=N_theta_ne, theta_min_ne=theta_min_ne, theta_max_ne=theta_max_ne,
        N_ell_ne=N_ell_ne, ell_min_ne=ell_min_ne, ell_max_ne=ell_max_ne,
        nbModes_ne=nbModes_ne,
        N_theta_nn=N_theta_nn, theta_min_nn=theta_min_nn, theta_max_nn=theta_max_nn,
