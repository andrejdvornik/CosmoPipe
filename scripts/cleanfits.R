...
# Last Modified : Tue 16 May 2023 06:45:13 AM CEST
#
#=========================================
...
if (any(classes=="integer64")) {
  ...
  Rfits::Rfits_write_table(file=input,fields,verbose=T,extname="FIELDS",overwrite_file=FALSE,create_file=FALSE,ext=length(extn)+1)
}
