#=========================================
#
# File Name : save_and_check_sacc.sh
# Created By : dvornik
# Creation Date : 05-08-2024
# Last Modified : Tues 05 Aug 2025 02:10:16 PM CEST
#
#=========================================
...
if [ "${STATISTIC^^}" != "XIEB" ] 
then 
@PYTHON3BIN@ @RUNROOT@/@SCRIPTPATH@/save_and_check_sacc.py \
...
_write_datablock "mcmc_inp_@BV:STATISTIC@" "MCMC_input_${non_linear_model}.sacc"
  ...
  _write_datablock "mcmc_inp_xiE" "MCMC_input_${non_linear_model}.sacc"
  _write_datablock "mcmc_inp_xiB" "MCMC_input_${non_linear_model}.sacc"
fi
