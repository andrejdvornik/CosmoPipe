...
if __name__ == '__main__':
    ...
    parser.add_argument('--c', type=float, help='condition, define the DEC value to split north and sound patches from main catalogue', nargs=1, default=-15.0, const=-15.0)
	...
	hduh = fits.BinTableHDU(data=newdata)
	
    hdu.writeto(args.output_file, overwrite=True)
    print(f'Input catalogue split into {patch} patch!')
