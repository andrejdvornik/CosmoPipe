...
OmRange = [omegam.min(),omegam.max()]
sigma8Range = [sigma8.min(),sigma8.max()]
...
xarr=np.linspace(OmRange[0] , OmRange[1] , 50)
yarr=sigma8_func(xarr,popt[0],popt[1])
ax[0].set_xlim(0.1,0.65)
