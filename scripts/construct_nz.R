...
# Last Modified : Wed 22 Mar 2023 03:51:57 PM CET
#
#=========================================
...
cat<-helpRfuncs::read_file(input[1])
...
#Output the Nz #/*fold*/{{{
write.file(file=input[2],data.frame(binstart=nzdist$breaks[1:length(nzdist$mids)],
