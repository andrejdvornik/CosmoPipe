...
parser = ArgumentParser(description='Take input information and construct a tomographic bin')
...
parser.add_argument("-y", "--zmin", dest="zmin",
    help="minimum z for bin definition (bin > z)", required=True)
parser.add_argument("-z", "--zmax", dest="zmax",
    help="maximum z for bin definition (bin <= z)",required=True)
parser.add_argument("-z", "--zmax", dest="zmax",
    help="maximum z for bin definition (bin <= z)",required=True)
